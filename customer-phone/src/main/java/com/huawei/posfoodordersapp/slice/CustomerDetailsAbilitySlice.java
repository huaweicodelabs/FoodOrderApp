...
public class CustomerDetailsAbilitySlice extends AbilitySlice implements DistributedNotificationPlugin.DistributedNotificationEventListener {
    ...
    public void onStart(Intent intent) {
        ...
        mTextUserName.setText("Vikram");
        mTextNoOfPeople.setText("1");
    }
    ...
    private OrderDetailModel formUserDetails() {
        ...
        orderDetailModel.setUsername(mTextUserName.getText().toString());
        orderDetailModel.setTotalNoPeople(Integer.parseInt(mTextNoOfPeople.getText().toString()));
