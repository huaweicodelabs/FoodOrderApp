 ...
 * @since 2020-12-04
 */
public class PaymentResultProvider extends BaseItemProvider {
     ...
     * @since 2020-12-04
     */
    public PaymentResultProvider(List<FoodMenuItem> listBasicInfo, Context context) {
    ...
    public Component getComponent(int position, Component component, ComponentContainer componentContainer) {
        ...
        if (temp == null) {
            temp = LayoutScatter.getInstance(context).parse(ResourceTable.Layout_item_paymentresult_layout, null, false);
            viewHolder = new ViewHolder();
            viewHolder.title = (Text) temp.findComponentById(ResourceTable.Id_food_item);
            viewHolder.prize = (Text) temp.findComponentById(ResourceTable.Id_amount);
            viewHolder.quantity = (Text) temp.findComponentById(ResourceTable.Id_qty);
        ...
        viewHolder.prize.setText("RS " + prize);
        return temp;
    }
    /**
