...
public class DistributedNotificationPlugin {
    ...
    private static final String NOTIFICATION_ORDER_ID = "notification_order_id";
    ...
    /* subscribeEvent used to subsribe for common events */
        ...
        commonEventSubscriber = new CommonEventSubscriber(commonEventSubscribeInfo) {
            ...
            public void onReceiveEvent(CommonEventData commonEventData) {
                ...
                if (receivedAction.equals(NOTIFICATION_ACTION)) {
                    ...
                    int notificaionOrderId = intent.getIntParam(NOTIFICATION_ORDER_ID, 0);
                    if (eventListener != null) {
                        eventListener.onEventReceive(notificaionContent, notificaionOrderId);
                    }
                }
            }
        };
    ...
    public void publishEvent(String event, int orderID) {
        ...
        intent.setParam(NOTIFICATION_ORDER_ID, orderID);
    ...
    public interface DistributedNotificationEventListener {
        ...
        void onEventReceive(String result, int orderId);
    }
