...
import static com.huawei.posfoodordersapp.utils.Constants.CALL_PAYMENT_SLICE;
...
public class FoodPaymentDetailsAbilitySlice extends AbilitySlice {
    ...
    private void initClickListener() {
        ...
        mBtnPay.setClickedListener(new Component.ClickedListener() {
            @Override
    ...
    private void calculateTotal() {
        ...
        totalvalue.setText("RS " + String.valueOf(total));
